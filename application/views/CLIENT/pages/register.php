        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form  action="<?php echo site_url('CTC_Client/addClient')?>" method="POST" class="pt-3">
                ...
                Vous avez déjà un compte?<a href="<?php echo site_url('CTC_Client/index')?>" class="text-primary">Se connecter</a>
                </div>
            </div>
          </div>
        </div>
